...
export class ModellingViewComponent extends RxUnsubscribe implements OnInit, OnDestroy {
    ...
    constructor(@Inject(PLATFORM_ID) private platformId: unknown, private cdr: ChangeDetectorRef, private _matStepperIntl: MatStepperIntl, private snackBar: MatSnackBar) {
        super();
