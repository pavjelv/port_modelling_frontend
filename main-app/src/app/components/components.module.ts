...
@NgModule({
    ...
    exports: [SystemAnimationComponent, CommonReactWrapperComponent, KendallNotationComponent],
    imports: [CommonModule, MatSliderModule, TranslateModule.forChild(), MatCardModule, MatListModule, MatExpansionModule, MatTableModule],
})
