...
import { SymbolsDescriptionComponent } from "./symbols-description.component";

describe("SymbolsDescriptionComponent", () => {
    let component: SymbolsDescriptionComponent;
    let fixture: ComponentFixture<SymbolsDescriptionComponent>;
    ...
    beforeEach(
        waitForAsync(() => {
            ...
            TestBed.configureTestingModule({
                declarations: [SymbolsDescriptionComponent],
                imports: [
                    ComponentsModule,
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(SymbolsDescriptionComponent);
