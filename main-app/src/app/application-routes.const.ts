...
export const APPLICATION_ROUTES: Routes = [
    ...
    {
        path: "modelling-view",
        loadChildren: () => import("./modules/modelling-view/modelling-view.module").then((m) => m.ModellingViewModule),
        data: {
            configuration: {
    ...
    {
        path: "calculate",
        loadChildren: () => import("./modules/calculate-values/calculate-values.module").then((m) => m.CalculateValuesModule),
        data: { state: "lazy" },
    },
    {
        path: "**",
